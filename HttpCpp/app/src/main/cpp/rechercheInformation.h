...
public:
    ...
    static void searchCutLeft(std::string *sentence, std::string sentenceToSearch,
                              bool cutSentenceToSearch = true) {
    ...
    static void searchCutRight(std::string *sentence, std::string sentenceToSearch,
                               bool cutSentenceToSearch = true) {
        unsigned int nb = sentence->find(sentenceToSearch);
        if (nb > sentence->size()) {
            sentence->replace(0, sentence->size(), "");
